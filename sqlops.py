...
try:
	...
	print
	print red+" [-] Please install 'requests' library"
	print green+"     : pip install requests"
	print
	sys.exit()
...
def app():
	...
	for opt,arg in opts:
		if opt == '-f':
			...
			try:
				fileO = open('README.md', "r")
				words = fileO.readlines()
				fileO.close()
				print
				print "\n".join(words)
				print
				...
				print
				print red+" [-] Not cant find file: README.md"+end
				print
				sys.exit()
		else:
			banner()
